...
exports.Deleter = exports.Updater = exports.Finder = exports.Inserter = void 0;
/**
...
var Inserter = /** @class */ (function () {
    ...
    Inserter.insertMany = function (collection, documents) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, collection.insertMany(documents)];
...
var Finder = /** @class */ (function () {
    ...
    Finder.findAll = function (collection, query) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var Updater = /** @class */ (function () {
    ...
    Updater.updateMany = function (collection, filter, updateQuery) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, collection.updateMany(filter, updateQuery)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
...
var Deleter = /** @class */ (function () {
    ...
    Deleter.deleteMany = function (collection, filter) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, collection.deleteMany(filter)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
